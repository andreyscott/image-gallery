 ...
 const Card = ({ image })  =>{     
  return (
    ...
    <div className='max-w-screen-sm  w-96 mx-4 max-h-fit rounded-lg overflow-hidden shadow-xl  transition ease-in-out delay-150 bg-slate-200 hover:-translate-y-1 hover:scale-105 hover:bg-teal-400 duration-300 '>
        <img 
        ...
        <div> 
        <strong className='p-1'>  User:</strong>{image.user}</div>
   {
       image.userImageURL && <img className='rounded-full  w-10 mr-2' src={image.userImageURL} alt="some images"/>
   }
</div>
